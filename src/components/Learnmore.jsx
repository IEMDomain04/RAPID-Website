...
function Learnmore() {
  return (
    <div className='w-11/12 sm:w-9/12 flex flex-col justify-self-center '>
      ...
      <div>
        <div data-aos="fade-up" data-aos-duration="2000" data-aos-delay="500" className='px-8 py-10 space-y-5 mt-10'>
        ...
        <section className='space-y-14'>
          <div data-aos="fade-up" data-aos-duration="2000" data-aos-delay="500" className='px-8 py-8 space-y-5 bg-gray-900 border border-blue-600 rounded-md'>
          ...
          <div data-aos="fade-up" data-aos-duration="2000" className='px-8 py-8 space-y-5 bg-gray-900 border border-blue-600 rounded-md'>
